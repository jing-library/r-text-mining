...
One of the first steps used in text analysis, is word frequency. In order to count the words, we first need to remove extremely common works called stop words such as "the", "is", "are" and others in English. We can remove (stop_words) with an anti_join(). 
